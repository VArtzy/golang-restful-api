...
func TestGetCaregorySuccess(t *testing.T) {
    db := setupTestDB()
    truncateCategory(db)
...
func TestGetCaregoryFailed(t *testing.T) {
    db := setupTestDB()
    truncateCategory(db)
    router := setupRouter(db)
...
func TestDeleteCaregorySuccess(t *testing.T) {
    db := setupTestDB()
    truncateCategory(db)
...
func TestDeleteCaregoryFailed(t *testing.T) {
    db := setupTestDB()
    truncateCategory(db)
    router := setupRouter(db)
